...
class KelasDosen extends CI_Controller {
    ...
    public function index()
	{
		$data = [
			...
			'judul'	=> 'Kelas '.text_fill('pengajar'),
			'subjudul'=> 'Data Kelas '.text_fill('pengajar')
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Kelas '.text_fill('pengajar'),
			'subjudul'	=> 'Tambah Data Kelas '.text_fill('pengajar'),
	...
	public function edit($id)
	{
		$data = [
			'user' 			=> $this->ion_auth->user()->row(),
			'judul'			=> 'Edit Kelas '.text_fill('pengajar'),
			'subjudul'		=> 'Edit Data Kelas '.text_fill('pengajar'),
	...
	public function save()
	{
		...
		$this->form_validation->set_rules('dosen_id', text_fill('pengajar'), 'required');
