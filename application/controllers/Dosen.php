...
class Dosen extends CI_Controller
{
	...
	public function index()
	{
		$data = [
			...
			'judul'		=> text_fill('pengajar'),
			'subjudul' 	=> 'Data '. text_fill('pengajar')
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah ' . text_fill('pengajar'),
			'subjudul' 	=> 'Tambah Data '. text_fill('pengajar'),
	...
	public function edit($id)
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Edit '. text_fill('pengajar'),
			'subjudul'	=> 'Edit Data '. text_fill('pengajar'),
			'matkul'	=> $this->master->getAllMatkul(),
	...
	public function save()
	{
		...
		$this->form_validation->set_rules('nama_dosen', 'Nama '. text_fill('pengajar'), 'required|trim|min_length[3]|max_length[50]');
		$this->form_validation->set_rules('email', 'Email', 'required|trim|valid_email' . $u_email);
		$this->form_validation->set_rules('matkul', text_fill('pelajaran'), 'required');
	...
	public function import($import_data = null)
	{
		$data = [
			'user' => $this->ion_auth->user()->row(),
			'judul'	=> text_fill('pengajar'),
			'subjudul' => 'Import Data '.text_fill('pengajar'),
			'matkul' => $this->master->getAllMatkul()
		];
