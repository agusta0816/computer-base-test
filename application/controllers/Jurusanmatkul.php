...
class JurusanMatkul extends CI_Controller {
    ...
    public function index()
	{
		$data = [
			...
			'judul'	=> 'Jurusan '.text_fill('pelajaran'),
			'subjudul'=> 'Data Jurusan '.text_fill('pelajaran')
		];
	...
	public function add()
	{
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> 'Tambah Jurusan '.text_fill('pelajaran'),
			'subjudul'	=> 'Tambah Data Jurusan '.text_fill('pelajaran'),
	...
	public function edit($id)
	{
		$data = [
			'user' 			=> $this->ion_auth->user()->row(),
			'judul'			=> 'Edit Jurusan '.text_fill('pelajaran'),
			'subjudul'		=> 'Edit Data Jurusan '.text_fill('pelajaran'),
	...
	public function save()
	{
		...
		$this->form_validation->set_rules('matkul_id', text_fill('pelajaran'), 'required');
