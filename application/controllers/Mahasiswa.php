...
class Mahasiswa extends CI_Controller
{
	...
	public function index()
	{
		$data = [
			...
			'judul'	=> text_fill('peserta'),
			'subjudul' => 'Data '.text_fill('peserta')
		];
	...
	public function add()
	{
		$data = [
			'user' => $this->ion_auth->user()->row(),
			'judul'	=> text_fill('peserta'),
			'subjudul' => 'Tambah Data '.text_fill('peserta')
		];
	...
	public function edit($id)
	{
		...
		$data = [
			'user' 		=> $this->ion_auth->user()->row(),
			'judul'		=> text_fill('peserta'),
			'subjudul'	=> 'Edit Data '.text_fill('peserta'),
	...
	public function import($import_data = null)
	{
		$data = [
			'user' => $this->ion_auth->user()->row(),
			'judul'	=> text_fill('peserta'),
			'subjudul' => 'Import Data '.text_fill('peserta'),
