        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="alert bg-purple">
                    ...
                    Jika kolom <?= text_fill('pengajar');?> kosong, berikut ini kemungkinan penyebabnya :
                    <br><br>
                    <ol class="pl-4">
                        <li>Anda belum menambahkan master data <?= text_fill('pengajar');?> (Master <?= text_fill('pengajar');?> kosong/belum ada data sama sekali).</li>
                        <li><?= text_fill('pengajar');?> sudah ditambahkan, jadi anda tidak perlu tambah lagi. Anda hanya perlu mengedit data kelas <?= text_fill('pengajar');?> nya saja.</li>
                    </ol>
                </div>
            </div>
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label><?= text_fill('pengajar');?></label>
