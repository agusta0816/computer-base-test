        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="alert bg-purple">
                    ...
                    Jika kolom <?= text_fill('pelajaran');?> kosong, berikut ini kemungkinan penyebabnya :
                    <br><br>
                    <ol class="pl-4">
                        <li>Anda belum menambahkan master data <?= text_fill('pelajaran');?> (Master <?= text_fill('pelajaran');?> kosong/belum ada data sama sekali).</li>
                        <li><?= text_fill('pelajaran');?> sudah ditambahkan, jadi anda tidak perlu tambah lagi. Anda hanya perlu mengedit data Jurusan <?= text_fill('pelajaran');?> nya saja.</li>
                    </ol>
                </div>
            </div>
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label><?= text_fill('pelajaran');?></label>
