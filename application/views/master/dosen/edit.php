    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <div class="form-group">
                    <label for="nama_dosen">Nama <?= text_fill('pengajar');?></label>
                    <input value="<?=$data->nama_dosen?>" type="text" class="form-control" name="nama_dosen" placeholder="Nama <?= text_fill('pengajar');?>">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    <label for="email">Email <?= text_fill('pengajar');?></label>
                    <input value="<?=$data->email?>" type="text" class="form-control" name="email" placeholder="Email <?= text_fill('pengajar');?>">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    <label for="matkul"><?= text_fill('pelajaran');?></label>
                    <select name="matkul" id="matkul" class="form-control select2" style="width: 100%!important">
                        <option value="" disabled selected>Pilih <?= text_fill('pelajaran');?></option>
