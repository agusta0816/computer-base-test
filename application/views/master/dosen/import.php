<div class="box">
    ...
    <div class="box-body">
        <ul class="alert alert-info" style="padding-left: 40px">
            ...
            <li>Untuk data <?= text_fill('pelajaran');?>, hanya bisa diisi menggunakan ID <?= text_fill('pelajaran');?>. <a data-toggle="modal" href="#matkulId" style="text-decoration:none" class="btn btn-xs btn-primary">Lihat ID</a>.</li>
        </ul>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Data <?= text_fill('pelajaran');?></h4>
            </div>
            <div class="modal-body">
                <table id="matkul" class="table table-condensed table-striped">
                    <thead>
                        <th>ID</th>
                        <th><?= text_fill('pelajaran');?></th>
                    </thead>
                    <tbody>
