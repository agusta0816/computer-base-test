        ...
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_dosen" placeholder="Nama <?= text_fill('pengajar');?>">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    <label for="email">Email <?= text_fill('pengajar');?></label>
                    <input type="text" class="form-control" name="email" placeholder="Email <?= text_fill('pengajar');?>">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
